...
- (id)initWithFrame:(CGRect)frame
{
    if ((self = [super initWithFrame:CGRectMake(CGRectGetMinX(frame), CGRectGetMinY(frame), CGRectGetWidth(frame), 34.0)]))
	{
		...
		self.searchFrame.backgroundColor = [UIColor colorFromHexString:@"#4CAF50"];
		...
		self.searchFrame.layer.borderColor = [UIColor colorFromHexString:@"#4CAF50"].CGColor;
        ...
        self.searchField.tintColor = [UIColor colorFromHexString:@"#4CAF50"];
		self.searchField.font = [UIFont fontWithName:@"AvenirNext-Regular" size:16.0];
		self.searchField.textColor = [UIColor colorFromHexString:@"#4CAF50"];
        ...
        self.searchImageViewOn.tintColor = [UIColor colorFromHexString:@"#4CAF50"];
		self.searchImageViewOn.image = [[UIImage imageNamed:@"NavBarIconSearch_blue"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
        ...
        self.searchImageCircle.tintColor = [UIColor colorFromHexString:@"#4CAF50"];
		self.searchImageCircle.image = [[UIImage imageNamed:@"NavBarIconSearchCircle_blue"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
        ...
        self.searchImageCrossLeft.tintColor = [UIColor colorFromHexString:@"#4CAF50"];
		self.searchImageCrossLeft.image = [[UIImage imageNamed:@"NavBarIconSearchBar_blue"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
        ...
        self.searchImageCrossRight.tintColor = [UIColor colorFromHexString:@"#4CAF50"];
		self.searchImageCrossRight.image = [[UIImage imageNamed:@"NavBarIconSearchBar2_blue"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
...
- (void)hideSearchBar:(id)sender
{
	if (self.state == INSSearchBarStateSearchBarVisible || self.state == INSSearchBarStateSearchBarHasContent)
	{
		...
		[UIView animateWithDuration:kINSSearchBarAnimationStepDuration animations:^{
			...
			self.searchFrame.layer.backgroundColor = [UIColor colorFromHexString:@"#4CAF50"].CGColor;
			self.searchImageViewOff.alpha = 1.0;
			self.searchImageViewOn.alpha = 0.0;
			self.searchField.alpha = 0.0;
