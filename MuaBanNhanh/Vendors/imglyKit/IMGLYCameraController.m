...
- (void)takePhotoWithCompletionHandler:(void (^)(UIImage *processedImage, NSError *error))completionHandler  {
    ...
    // TODO: DK
    [self.stillCamera capturePhotoAsImageProcessedUpToFilter:[self.liveStreamFilterManager currentFilter] withCompletionHandler:^(UIImage *processedImage, NSError *error) {
